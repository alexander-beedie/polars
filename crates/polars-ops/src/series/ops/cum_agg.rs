...
fn update_max<T>(state: &mut T, v: Option<T>) -> Option<Option<T>>
where
    T: Copy + MinMax,
{
    match v {
...
fn update_min<T>(state: &mut T, v: Option<T>) -> Option<Option<T>>
where
    T: Copy + MinMax,
{
    match v {
...
fn update_sum<T>(state: &mut T, v: Option<T>) -> Option<Option<T>>
where
    T: Copy + AddAssign,
{
    match v {
...
fn update_prod<T>(state: &mut T, v: Option<T>) -> Option<Option<T>>
where
    T: Copy + Mul<Output = T>,
{
    match v {
    ...
    ChunkedArray<T>: FromIterator<Option<T::Native>>,
{
    ...
    cum_scan_numeric(ca, reverse, init, update_max)
}
    ...
    ChunkedArray<T>: FromIterator<Option<T::Native>>,
{
    ...
    cum_scan_numeric(ca, reverse, init, update_min)
}
    ...
    ChunkedArray<T>: FromIterator<Option<T::Native>>,
{
    ...
    cum_scan_numeric(ca, reverse, init, update_sum)
}
    ...
    ChunkedArray<T>: FromIterator<Option<T::Native>>,
{
    ...
    cum_scan_numeric(ca, reverse, init, update_prod)
}
