...
class PySeries:
    ...
    def struct_fields(self) -> pylist[str]: ...
    ...
    def chunk_lengths(self) -> pylist[int]: ...
    def name(self) -> str: ...
    ...
    def get_chunks(self) -> pylist[Any]: ...
    ...
    def list_to_struct(self, fields: Sequence[str]) -> PySeries: ...
    ...
    def is_empty(self, ignore_nulls: bool) -> bool: ...
...
class PyDataFrame:
    ...
    def estimated_size(self) -> int: ...
    def dtype_strings(self) -> pylist[str]: ...
    ...
    def as_str(self) -> str: ...
    def get_columns(self) -> pylist[PySeries]: ...
    def columns(self) -> pylist[str]: ...
    def set_column_names(self, names: Sequence[str]) -> None: ...
    def dtypes(self) -> pylist[Any]: ...
    def n_chunks(self) -> int: ...
    ...
    def n_unique(self, subset: Sequence[PyExpr] | None) -> int: ...
    def to_dummies(
        self,
    ...
    def shrink_to_fit(self) -> None: ...
    def hash_rows(self, seed: int) -> PySeries: ...
    def transpose(
    ...
    def row_tuples(self) -> pylist[tuple[Any, ...]]: ...
    def to_arrow(self, compat_level: Any) -> pylist[Any]: ...
    def to_pandas(self) -> pylist[Any]: ...
    def __arrow_c_stream__(self, requested_schema: Any | None) -> Any: ...
...
class PyLazyFrame:
    ...
    @staticmethod
    def new_from_dataset_object(
        dataset_object: Any, resolve_heavy_sources: int | None = None
    ) -> PyLazyFrame: ...
    @staticmethod
    ...
    def _retained_parquet_footers(self) -> pylist[pylist[tuple[int, int]]]: ...
    ...
    def join_where(
        self,
        other: PyLazyFrame,
        predicates: Sequence[PyExpr],
        how: JoinType,
        suffix: str,
    ) -> PyLazyFrame: ...
    def gather(self, other: PyLazyFrame, null_on_oob: bool) -> PyLazyFrame: ...
    ...
    def hint_sorted(
        self,
        columns: pylist[str],
        descending: pylist[bool],
        nulls_last: pylist[bool],
    ) -> PyLazyFrame: ...
...
class PyExpr:
    ...
    def gather(self, idx: PyExpr, null_on_oob: bool) -> PyExpr: ...
    def get(
        self,
        idx: PyExpr,
        *,
    ...
    def arr_dot(self, other: PyExpr) -> PyExpr: ...
    ...
    def cat_to(self, dtype: PyDataTypeExpr, strict: bool) -> PyExpr: ...
    def cat_physical(self) -> PyExpr: ...
    ...
    def meta_pop(self, schema: Schema | None = None) -> pylist[PyExpr]: ...
    def meta_root_names(self) -> pylist[str]: ...
    ...
    @staticmethod
    def str_format(f_string: str, exprs: pylist[PyExpr]) -> PyExpr: ...
    ...
    def struct_drop(self, names: Sequence[str], strict: bool) -> PyExpr: ...
...
class PyOptFlags:
    ...
    @property
    def query_monitoring(self) -> bool: ...
    @query_monitoring.setter
    def query_monitoring(self, value: bool) -> None: ...
...
def list(s: Sequence[PyExpr]) -> PyExpr: ...
...
def _bench_parquet_metadata_bincode_size(
    path: str, projection: pylist[str] | None, predicate: pylist[str]
) -> int: ...
...
def __register_startup_deps(warn_function: Callable[..., None]) -> None: ...
...
def polars_schema_field_from_arrow_c_schema(schema_object: Any) -> tuple[str, Any]: ...
def polars_schema_to_pycapsule(schema: Schema, compat_level: CompatLevel) -> Any: ...

class PyLazyGroupBy:
    def agg(self, aggs: pylist[PyExpr]) -> PyLazyFrame: ...
    def head(self, n: int) -> PyLazyFrame: ...
    def tail(self, n: int) -> PyLazyFrame: ...
    def having(self, predicates: pylist[PyExpr]) -> PyLazyGroupBy: ...
    def map_groups(
...
class PyCatalogClient:
    ...
    def list_catalogs(self) -> pylist[Any]: ...
    def list_namespaces(self, catalog_name: str) -> pylist[Any]: ...
    def list_tables(self, catalog_name: str, namespace: str) -> pylist[Any]: ...
    def get_table_info(
...
def _known_timezones() -> pylist[str]: ...
...
class NodeTraverser:
    def get_exprs(self) -> pylist[PyExprIR]: ...
    def get_inputs(self) -> pylist[int]: ...
    ...
    def add_expressions(
        self, expressions: pylist[PyExpr]
    ) -> tuple[pylist[int], int]: ...
    def set_expr_mapping(self, mapping: pylist[int]) -> None: ...
    def unset_expr_mapping(self) -> None: ...

class PyCollectBatches:
    def start(self) -> None: ...
    def __iter__(self) -> PyCollectBatches: ...
