...
def test_lit_dtypes() -> None:
    ...
    d_ms_aware = datetime(
        2049, 10, 5, 1, 2, 3, 987000, tzinfo=ZoneInfo("Asia/Kathmandu")
    )
    ...
    df = pl.DataFrame(
        {
            ...
            "dtm_ms_aware": lit_series(d, pl.Datetime("ms", "Asia/Kathmandu")),
            "dtm_us_aware": lit_series(d, pl.Datetime("us", "Asia/Kathmandu")),
            "dtm_ns_aware": lit_series(d, pl.Datetime("ns", "Asia/Kathmandu")),
